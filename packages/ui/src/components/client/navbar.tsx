...
export const Navbar = async ({ tree }: NavbarProps) => {
    ...
    const socialLinks = useMemo(() => {
        return Object.entries(socials).map(([i, v]) => {
            ...
            return (
                <a
                    className='hover:bg-base-300 dark:hover:bg-base-900 flex items-center justify-center rounded-xs p-2 transition-all duration-300'
                    href={v}
