        ...
        () => (
            ...
            >
                ...
                <HiOutlineHashtag
                    ...
                    className='hover:!text-accent-600 group-hover:text-accent-500 hidden text-transparent transition-all duration-300 focus:outline-none focus:ring-0 lg:inline-block'
                />
            </Var>
        ),
