            ...
            <body className='relative '>
                <main>
                    ...
                    <div className='relative flex flex-row justify-center gap-8 py-16 md:py-24'>
                        ...
                        <div className='prose prose-$COLOR px-6 prose-invert prose-ul:my-0 prose-ol:my-0 prose-p:my-4 prose-headings:my-2 prose-headings:mt-4 prose-headings:w-full prose-headings:border-b prose-headings:border-white/15 prose-ul:mb-4 prose-ol:mb-4 prose-headings:pb-1.5 prose-a:decoration-dotted hover:prose-a:text-$ACCENT-COLOR-500 prose-ol:my-0 prose-ul:my-0 prose-hr:border-white/20 flex h-fit w-screen flex-shrink-0 flex-col items-start lg:max-w-[40%] lg:px-0'>
                            <DocsBreadcrumbs />
                            {children}
