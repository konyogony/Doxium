...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbSeparator } from 'server/breadcrumb';
...
export const Breadcrumbs = async ({ tree }: { tree: TreeNode[] }) => {
