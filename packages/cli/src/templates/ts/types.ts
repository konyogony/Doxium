...
export const ShikiThemeBackgroundHexDimmed: Record<BundledTheme, string> = {
    ...
    'gruvbox-dark-hard': '#161616',
    'gruvbox-dark-medium': '#1a1918',
    'gruvbox-dark-soft': '#22201e',
    'gruvbox-light-hard': '#c6c1ac',
    'gruvbox-light-medium': '#c8bea2',
    'gruvbox-light-soft': '#c1b89a',
    houston: '#1E2025',
